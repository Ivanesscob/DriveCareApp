...

{
...

    {
        ...
        /// <summary>Открывает страницу и очищает журнал навигации (чтобы «назад» не возвращал на карту и т.п.).</summary>
        public static void SetFrameWithoutBackStack<T>() where T : Page, new()
        {
