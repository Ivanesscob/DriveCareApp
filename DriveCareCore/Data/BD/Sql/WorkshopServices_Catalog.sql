...
BEGIN
    CREATE TABLE dbo.WorkshopServices (
        ...
        Unit            NVARCHAR(50)     NOT NULL CONSTRAINT DF_WorkshopServices_Unit DEFAULT(N'усл.'),
...
BEGIN
    CREATE TABLE dbo.TaskServiceLines (
        ...
        Unit                NVARCHAR(50)     NOT NULL CONSTRAINT DF_TaskServiceLines_Unit DEFAULT(N'усл.'),
        UnitPrice           DECIMAL(18, 2)   NOT NULL CONSTRAINT DF_TaskServiceLines_Price DEFAULT(0),
        Amount              DECIMAL(18, 2)   NOT NULL CONSTRAINT DF_TaskServiceLines_Amount DEFAULT(0),
        SortOrder           INT              NOT NULL CONSTRAINT DF_TaskServiceLines_Sort DEFAULT(0),
        CONSTRAINT FK_TaskServiceLines_Task FOREIGN KEY (TaskId) REFERENCES dbo.Tasks(RowId) ON DELETE CASCADE
    );
...
BEGIN
    CREATE TABLE dbo.TaskPartLines (
        ...
        Unit            NVARCHAR(50)     NOT NULL CONSTRAINT DF_TaskPartLines_Unit DEFAULT(N'шт.'),
        UnitPrice       DECIMAL(18, 2)   NOT NULL CONSTRAINT DF_TaskPartLines_Price DEFAULT(0),
        Amount          DECIMAL(18, 2)   NOT NULL CONSTRAINT DF_TaskPartLines_Amount DEFAULT(0),
        SortOrder       INT              NOT NULL CONSTRAINT DF_TaskPartLines_Sort DEFAULT(0),
        CONSTRAINT FK_TaskPartLines_Task FOREIGN KEY (TaskId) REFERENCES dbo.Tasks(RowId) ON DELETE CASCADE
    );
